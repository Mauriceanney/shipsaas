...
const features = [
  {
    ...
    description:
      "Email/password and OAuth providers with Auth.js. Secure session management.",
    icon: (
      <svg
  ...
  },
  {
    title: "Database",
    description:
      "PostgreSQL with Prisma ORM. Type-safe queries and easy migrations.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    title: "Email",
    description:
      "Transactional emails with Resend and React Email templates.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    title: "Testing",
    description:
      "Unit tests with Vitest and E2E tests with Playwright. TDD workflow.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
  ...
  },
  {
    title: "Deployment",
    description:
      "Docker-ready with CI/CD pipelines. Deploy to Digital Ocean with ease.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
