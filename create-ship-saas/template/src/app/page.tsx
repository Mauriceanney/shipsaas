      ...
      <div className="max-w-4xl mx-auto text-center space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            A complete ShipSaaS boilerplate with authentication, database, AI
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Watch the complete walkthrough of this ShipSaaS boilerplate:
          </p>
          <div className="relative w-full max-w-3xl mx-auto">
            <div className="relative pb-[56.25%] h-0 overflow-hidden rounded-lg border">
              <iframe
                ...
                title="ShipSaaS Boilerplate Tutorial"
