...
async function main() {
  ...
  program
    .name('create-ship-saas')
    .description('Scaffold a new ShipSaaS application')
  ...
  try {
    ...
    try {
      ...
      if (!fs.existsSync(path.join(targetDir, '.git'))) {
        ...
        execSync('git commit -m "Initial commit from create-ship-saas"', {
          cwd: targetDir,
          stdio: 'pipe'
        });
    ...
    // Display next steps
    console.log();
    console.log(chalk.bold.green('✨ Your ShipSaaS app is ready!\n'));
